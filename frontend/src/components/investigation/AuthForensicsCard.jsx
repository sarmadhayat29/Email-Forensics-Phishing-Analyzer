    ...
    <div className="space-y-4 font-mono text-xs">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-soc-bg border border-emerald-900/40 rounded-xl space-y-2">
          ...
          <p className="text-[11px] text-slate-400 leading-tight">{auth.spf_details || 'SPF record details unavailable.'}</p>
        </div>
        ...
        <div className="p-4 bg-soc-bg border border-emerald-900/40 rounded-xl space-y-2">
          ...
          <p className="text-[11px] text-slate-400 leading-tight">{auth.dkim_details || 'DKIM signature verification details.'}</p>
        </div>
        ...
        <div className="p-4 bg-soc-bg border border-emerald-900/40 rounded-xl space-y-2">
          ...
          <p className="text-[11px] text-slate-400 leading-tight">{auth.dmarc_details || 'DMARC policy alignment status.'}</p>
        </div>
